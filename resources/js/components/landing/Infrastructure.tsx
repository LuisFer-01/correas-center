...
export default function Infrastructure() {
    ...
    const caracteristicas = globals.caracteristicas_infraestructura || [];
    const capacidades = globals.capacidades_infraestructura || [];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 bg-[#EA0A2A]/10 rounded-full px-4 py-2 mb-4">
                        <LucideIcons.Factory size={16} className="text-[#EA0A2A]" />
                ...
                {caracteristicas.length > 0 && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {caracteristicas.map((feature: any) => {
                            const IconComponent = (LucideIcons as any)[feature.icon] || LucideIcons.Factory;
                            return (
                                <div
                                    key={feature.id}
                ...
                {capacidades.length > 0 && (
                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {capacidades.map((capability: any) => {
                                const IconComponent = (LucideIcons as any)[capability.icon] || LucideIcons.CheckCircle2;
                                return (
                                    <div
                                        key={capability.id}
