                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="mt-4 bg-gray-50 rounded-lg p-4 border border-gray-100">
                                    <p className="text-gray-700"><strong>Email:</strong> ventas@correascenter.com</p>
                                    <p className="text-gray-700"><strong>Teléfono:</strong> +591 7 7306-576</p>
                                    <p className="text-gray-700"><strong>Dirección:</strong> Av. Grigotas 2do anillo, Santa Cruz de la Sierra, Bolivia</p>
                                </div>
                            </div>
                        </div>
                    </div>
