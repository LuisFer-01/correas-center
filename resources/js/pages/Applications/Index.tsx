...
export default function ApplicationsIndex() {
    const { industrias } = usePage<any>().props;
                        ...
                        {industrias.map((industria: any) => (
                            ...
                            >
                                ...
                                <div className="relative h-48 bg-gradient-to-br from-[#EA0A2A]/5 to-[#EA0A2A]/15 overflow-hidden flex items-center justify-center">
                                    {industria.imagen ? (
                                        <img src={industria.imagen} alt={industria.nombre} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                    ) : (
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="flex items-center gap-1.5 text-sm text-gray-600">
                                            ...
                                            <span>{industria.categorias_count} productos</span>
                                        </div>
                                        <div className="flex items-center gap-1.5 text-sm text-gray-600">
            ...
            <section className="py-12 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="https://wa.me/59177306576?text=Hola%2C%20necesito%20soluciones%20para%20mi%20industria" target="_blank" rel="noopener noreferrer" className="bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-3 rounded-lg font-semibold transition-all hover:scale-105 inline-flex items-center justify-center gap-2">
