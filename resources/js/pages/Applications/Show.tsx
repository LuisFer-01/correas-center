...
export default function IndustryShow() {
    const { industria } = usePage<any>().props;
        ...
        <AppLayout>
            ...
            <section className="py-12 md:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {industria.categorias.length > 0 ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {industria.categorias.map((categoria: any) => (
                                <Link
                                    key={categoria.id}
            ...
            <section className="py-12 md:py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {industria.servicios.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {industria.servicios.map((servicio: any) => (
                                <Link
                                    key={servicio.id}
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-br from-[#EA0A2A] to-[#c90825] rounded-2xl p-8 md:p-12 text-white text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link href="/contact" className="bg-white/10 hover:bg-white/20 text-white px-8 py-3 rounded-lg font-semibold transition-all border border-white/20">
                                Contactar Ahora
                            </Link>
                        </div>
                    </div>
