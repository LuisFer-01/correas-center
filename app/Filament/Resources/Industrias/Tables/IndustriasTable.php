        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('cambiarEstado')
                    ...
                    ->modalHeading(fn ($record) => $record->estado === 'activo' ? 'Desactivar Industria' : 'Activar Industria')
                    ->modalDescription(fn ($record) => $record->estado === 'activo'
                        ? '¿Estás seguro de desactivar esta industria? No se mostrará en el sitio web.'
                        : '¿Estás seguro de activar esta industria? Se mostrará en el sitio web.'
                    )
            ...
            ->emptyStateHeading('No hay industrias registradas')
            ->emptyStateDescription('Crea la primera industria para mostrar en la sección de aplicaciones.')
