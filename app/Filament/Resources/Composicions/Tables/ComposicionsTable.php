...
namespace App\Filament\Resources\Composicions\Tables;
...
class ComposicionsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('No hay composiciones registradas')
            ->emptyStateDescription('Crea la primera composición para usar en los detalles de categorías.')
