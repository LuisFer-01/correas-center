...
namespace App\Filament\Resources\Caracteristicas\Tables;
...
class CaracteristicasTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->emptyStateDescription('Crea la primera característica para usar en los detalles de categorías.')
